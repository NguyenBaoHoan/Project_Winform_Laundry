    ...
    public partial class Employee : Form
    {
        ...
        public void loadEmployee()
        {
            try
            {
                ...
                {
                    i++;
                    dgvEmployee.Rows.Add(i, emp.id, emp.name, emp.phone, emp.address,
        ...
        // Sự kiện khi văn bản trong ô tìm kiếm thay đổi
        ...
        private void dgvEmployee_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Edit") // Khi click vào nút Sửa
            {
                ...
                module.txtAddress.Text = dgvEmployee.Rows[e.RowIndex].Cells[4].Value.ToString();
